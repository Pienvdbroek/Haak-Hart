...
const navigation = computed(() => {
    if (userRole.value === 'admin') return allNavigation.admin;
    return allNavigation.user;
});
...
<template>
    <div class="min-h-screen bg-gray-50">
        <header
            class="sticky top-0 z-40 bg-magazijn-purple text-magazijn-white"
        >
            <div class="flex h-[80px] items-center px-4 sm:px-8">
                ...
                >
                    ...
                    >
                        <span
                            class="text-[16px] font-extrabold tracking-[-0.18em]"
                            >MM</span
                        >
                    </div>
                    <div
                ...
                <div
                    class="ml-auto hidden items-center gap-8 text-right lg:flex"
                >
                    <div>
                        <div
